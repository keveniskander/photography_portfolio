    ...
    <>
      ...
      <div className="article-container">
        ...
        <div className="article-text">
          <p>The disorganized, scrappy mess of a roll speaks for itself. It can be succinctly described as a grouping of terribly unbalanced photos with incredibly unique perspectives. We start our journey
